...
# --- Logging form ---
# Place roll & hit controls outside form for reactivity
...
# Re-display the roll & hit inside the form
_ = form.selectbox("🎲 Roll outcome (2–12)", [roll], index=0, disabled=True, label_visibility="collapsed")
_ = form.radio("🎯 Did you hit your target tile?", ["No","Yes"], index=1 if auto_hit else 0, horizontal=True)
